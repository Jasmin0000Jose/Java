    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (ch) {
                ...
                case 1:
                    System.out.printf("Enter the value to be inserted first:");
                    po = sc.nextInt();
                    d.InsertFirst(po);
                    break;

                case 2:
                    System.out.printf("Enter item after which an element is to be inserted:");
                    it = sc.nextInt();
                ...
                case 3:
                    System.out.printf("Enter item before which an element is to be inserted:");
                    it = sc.nextInt();
                    System.out.printf("Value to be inserted:");
                    po = sc.nextInt();
                ...
                case 6:
                    System.out.printf("Enter the value to be deleted:");
                    po = sc.nextInt();
                    d.Delete(po);
                    break;
